...
class PostViewSet(viewsets.ModelViewSet):
    ...
    """
    In order to user different serializers for different actions
    override the get_serializer_class(self) method
    """
    ...
    """
    get_permissions(self) method helps to separate 
